...
plot_availability_calendar <- function(daylight_availability_dt, by_idf_summary,
  ...
  ggplot() +
    ...
    theme(
      ...
      # horizontal -- pedido do Paulo, 2026-09 (o rotulo de 1 so' caracter,
      # "M T W T. F S S.", ja' cabe na largura estreita de cada painel
      # mesmo na horizontal, ao contrario de um rotulo de data completo --
      # a rotacao vertical anterior deixou de ser necessaria)
