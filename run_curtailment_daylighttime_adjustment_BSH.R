...
## (R/curtailment_daylighttime_adjustment.R) para o parque Bash (BSH) --
## carrega SO' os curtailments (load_curtailments.R, NAO o IDF_analysis.R
## inteiro -- nao le tracks/SCADA/heartbeats nem calcula
...
## source("run_curtailment_daylighttime_adjustment_BSH.R") na consola).
##
